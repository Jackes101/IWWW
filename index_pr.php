...
<header>
    <div id="banner">
        <div id="divPrihl">
            ...
            if ($_SESSION["role"]=="Admin")
                echo "<b>Přihlášený admin:</b><br>";
            else

            echo "<b>Přihlášený uživatel:</b><br>";
            ?>
    ...
    <nav id="menu">
        ...
        <a href="index_pr.php?page=kontakt">Kontakt</a>
        <?php
        if ($_SESSION["role"]=="Admin")
        {
            echo "<a href='zobrazUzivatele.php'>Uživatelé</a>";
            echo "<a href='upravSluzby.php'>Služby</a>";
        }
